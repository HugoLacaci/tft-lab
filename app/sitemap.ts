...
const STATIC = ["", "/guides", "/set", "/set/champions", "/set/traits", "/set/items", "/set/augments", "/set/wisps", "/set/comps", "/set/patch-notes", "/trainer", "/trainer/daily", "/trainer/puzzles", "/lab", "/lab/board", "/lab/odds", "/lab/econ", "/lab/cheatsheet", "/routine", "/tracker", "/compete", "/resources"];
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  for (const t of RANK_TIERS) urls.push({ url: `${base}/trainer/puzzles/${t.id}/`, lastModified: now });
